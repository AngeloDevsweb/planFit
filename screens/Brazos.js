...
import Brazo2 from '../images/brazo.jpg'
import firebase from '../database/firebase'
const Brazos = () => {
    const [users , setUsers] = useState([])

    useEffect(() => {
        firebase.db.collection('brazo').onSnapshot((querySnapshot)=>{
            const users = []
    ...
    return (
      <ScrollView>
        <View>
          <ImageBackground style={styles.imagen} source={Brazo2}>
            <Text style={styles.texto}>brazos en casa</Text>
          </ImageBackground>
        </View>
